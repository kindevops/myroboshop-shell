...
Y="\e[33m"
N="\e[0m"
MONGO_HOST=mongo.kintravel.shop
...
cp /home/ec2-user/myroboshop-shell/catalogue.service /etc/systemd/system/catalogue.service &>> $LOGFILE
...
cp /home/ec2-user/myroboshop-shell/mongo.repo /etc/yum.repos.d/mongo.repo &>> $LOGFILE
